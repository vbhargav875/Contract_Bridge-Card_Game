...
# while(k<1):
# 	turn = (lsp7 + 1)%4
# 	print("Current user's Turn : ",turn)
# 	print("Present Available List : ",avail_list)
# 	if(turn == 0):
# 		for i in c[0]:
# 			if i in avail_list:
# 				useable.append(i)
